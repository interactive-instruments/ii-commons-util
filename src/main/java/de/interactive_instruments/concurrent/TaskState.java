...
public interface TaskState {
    ...
    enum STATE {
        ...
        public boolean isFailed() { return code==53; }

        public boolean isCanceling() { return code==71; }

        public boolean isCanceled() { return code==89; }
    ...
    void addStateEventListener(TaskStateEventListener listener);
}
