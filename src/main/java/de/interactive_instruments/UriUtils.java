...
public final class UriUtils {
    ...
    /**
     * Return the parent location or the current URI if applicable, including a trailing slash
     *
     * @param uri
     *            URI
     ...
     *            query parameters
     * @param keysUpperCase
     *            if set to true the query parameter names are returned upper case
     * @return
     */
    public static String withQueryParameters(final String url, final Map<String, String> parameters,
     ...
     * @param outputStream
     * @param decode
     *            decode before copying to output stream
     * @throws IOException
     */
    private static void streamFromConnection(final URLConnection connection, final boolean encodeBase64,
     ...
     * @param uri
     *            uri to check
     * @throws UriNotAbsoluteException
     *             if the URI has no schema set
     */
    ...
    /**
     * Opens a connection to the server with the HTTP GET method and checks if the resource exists. If the server responds with 4XX or higher response codes, the method returns false.
     *
     * @param uri
     *            URL to check
     * @param cred
    ...
    /**
     * Opens a connection to the server with the HTTP GET method and checks if the resource exists. If the response code matches the acceptedHttpErrorCodes it returns true, otherwise if the server responds with 4XX or higher response codes, the method returns false.
     *
     * @param uri
     *            URL to check
     * @param cred
     *            URL credentials
     * @param acceptedHttpErrorCodes
     *            HTTP error codes that are accepted.
     * @throws UriNotAbsoluteException
     *             if the URL is not absolute
     * @return true if the resource exists, false otherwise
     */
