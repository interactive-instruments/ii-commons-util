...
public interface Copyable<T extends Copyable> {
     ...
     *
     * If the passed collection implements a copy Constructor Collection(Collection collection), the returned type will match the input type. Otherwise an ArrayList is returned.
     *
     * @param collection
     *            collection to copy
     * @param <T>
     ...
     *
     * If the passed set implements a copy Constructor Set(Set set), the returned type will match the input type. Otherwise a {@link LinkedHashSet} is returned, if the first item implements the {@link Object#equals(Object)} method and {@link Comparable}, otherwise a {@link TreeSet}.
     *
     * @param set
     *            set to copy
     * @param <T>
     ...
     *
     * The first item is checked, if the key and/or the value is copyable or if key and value reference the same object.
     *
     * If the passed map implements a copy Constructor Map(Map map), the returned type will match the input type. Otherwise a {@link LinkedHashMap} is returned, if the first item implements the {@link Object#equals(Object)} method and {@link Comparable}, otherwise a {@link TreeMap}.
     *
     * @param map
     * @param <K>
     *            value
