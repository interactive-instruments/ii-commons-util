...
final public class SUtils {
    ...
    /**
     * Splits a String into two Strings or returns null if regex not found. The matched word is not included in the result.
     *
     * @param str
     * @param regex
    ...
    /**
     * Returns a substring with the "right side" of the indexStr. i String a = "foo.bar" rigthOfSubStrOrNull(a, ".") == "bar"
     *
     * @param str
     *            input String
     * @param searchStr
     ...
     *
     * String a = "foo.bar" leftOfSubStrOrNull(a, ".") == "foo"
     *
     * @param str
     *            input String
     * @param searchStr
     ...
     *
     * Where <code>SUtils.compareNullSafeIgnoreCase(obj, toObj);</code> is like <code>obj.compareToIgnoreCase(toObj);</code>
     *
     * @see de.interactive_instruments.CmpUtils See CmpUtils for a comparison version which does not ignore case
     */
