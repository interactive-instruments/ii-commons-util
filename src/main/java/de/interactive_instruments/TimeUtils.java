...
public final class TimeUtils {
    ...
    /**
     * Returns the deltaTime as formatted String with hours and/or minutes or as seconds
     *
     * @param deltaTime
     * @return
     */
    ...
    /**
     * Returns the deltaTime as formatted String with minutes and/or seconds or as milliseconds
     *
     * @param deltaTime
     * @return
     */
    ...
    /**
     * Calculate the initial delay for a target time. Returns the delay in seconds, use <code>TimeUnit.SECONDS.toMillis()</code> to convert it to milliseconds.
     *
     * @param targetHour
     *            target hour
     * @param targetMin
